...
import { Button, Card, Collapse, Empty, message, Segmented, Select, Space, Statistic, Table, Tag, Typography } from 'antd'
import { FileSearchOutlined, FireOutlined, ReloadOutlined, SafetyCertificateOutlined } from '@ant-design/icons'
...
export default function ContentFactory(){
  ...
  return <div className="workspace-page factory-page">{holder}
    ...
    <Segmented block className="overview-pager factory-pager" value={tab} onChange={value=>setTab(value as typeof tab)} options={[
      {value:'script',label:'脚本识别'},
      {value:'clips',label:'批量剪辑'},
      {value:'safety',label:'敏感终审'},
    ]}/>
    ...
    {tab==='safety'&&<VisualModeration embedded/>}
  </div>
}
