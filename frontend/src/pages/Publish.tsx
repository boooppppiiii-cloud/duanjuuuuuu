...
export default function Publish({embedded=false}:{embedded?:boolean}){
 ...
 const focusForSystemEmoji=(draft:ContentDraft)=>{
  ...
  msg.info(navigator.userAgent.includes('Mac')?'按 Control + Command + 空格打开系统表情':'按 Win + . 打开系统表情')
 }
