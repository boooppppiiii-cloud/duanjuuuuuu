...
export function showLocalAssistantInstallPrompt(){
  Modal.info({
    title:'需要安装剧枢本地助手',
    width:520,
    okText:'关闭',
    content:<div className="local-assistant-prompt">
      <p>本地助手用于读取当前使用者自己电脑里的视频文件夹。源视频不会上传服务器。</p>
      ...
      <Space wrap>
        <Button type="primary" icon={<DownloadOutlined/>} href={LOCAL_ASSISTANT_DOWNLOAD_URL} download>下载 Windows 本地助手</Button>
