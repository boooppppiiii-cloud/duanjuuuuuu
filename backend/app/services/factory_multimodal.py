...
只输出严格 JSON：
{{"summary":"中文概括","sensitive":[{{"start":0,"end":0,"category":"软色情|低俗擦边|暴露|性暗示|色情|性行为|性暴力|暴力|血腥|其他","confidence":0.0,"overall_risk_score":0,"risk_scores":{{"body_focus":0,"action":0,"dialogue_context":0,"expression_audio":0,"scene_context":0}},"reasons":["必须同时描述画面/服装/动作与台词上下文"],"frame_indices":[1]}}],"high_energy":[{{"start":0,"end":0,"score":0,"reasons":["中文依据"],"frame_indices":[1]}}]}}"""
