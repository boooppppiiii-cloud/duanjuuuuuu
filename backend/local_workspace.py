...
def health():
    ...
    capabilities = ["meta_direct_local_v2", "meta_progress", "meta_cover_sync", "legacy_server_import_v1", "factory_cancel_v1", "factory_sensitive_policy_v2", "local_storage_manager_v1", "factory_model_proxy_v1", "meta_duration_guard_v1", "meta_metadata_guard_v1", "native_folder_picker_v1", "native_folder_picker_v2", "native_folder_picker_v3"]
    return {
        "status": "ok",
